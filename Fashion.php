...
<body>
    ...
    <div id="carouselBasicExample" class="carousel slide carousel-fade" data-mdb-ride="carousel" data-mdb-carousel-init>
        ...
        <div class="carousel-inner">
            <div class="carousel-item active">
                <img src="images/banner/12.jpg" class="d-block w-100" style="height: 450px;" alt="Sunset Over the City" />
            </div>

            <div class="carousel-item">
                <img src="images/banner/13.gif" class="d-block w-100" style="height: 450px;" alt="Canyon at Nigh" />
            </div>

            <div class="carousel-item">
                <img src="images/banner/14.png" class="d-block w-100" style="height: 450px;" alt="Cliff Above a Stormy Sea" />
            </div>
        </div>
    ...
    <!-- Men's Wear -->
    <div class="container">
        <h1 class="text-center m-3 text-black">Men's Wear</h1>
        <div class="products">
            <div class="row justify-content-center">
                <?php
                $select_product = mysqli_query($conn, "SELECT * FROM `products` WHERE category = 'men_wear'") or die('query failed');
    ...
    <!-- Women's Wear -->
    <div class="container">
        <h1 class="text-center m-3 text-black">Women's Wear</h1>
        <div class="products">
            <div class="row justify-content-center">
                <?php
                $select_product = mysqli_query($conn, "SELECT * FROM `products` WHERE category = 'women_wear'") or die('query failed');
                if (mysqli_num_rows($select_product) > 0) {
                    while ($fetch_product = mysqli_fetch_assoc($select_product)) {
                        $price = $fetch_product['price'];
                        $old_price = $fetch_product['old_price'];
