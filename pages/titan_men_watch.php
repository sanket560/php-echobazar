...
<head>
    ...
    <title>Titan Karishma Men Watch</title>
...
<body>
    ...
    <nav aria-label="..." style="width:83%; margin:10px auto; ">
        <ul class="pagination">
            ...
            <li class="page-item">
                <a class="page-link" href="../Watch.php">Watch</a>
            </li>
            <li class="page-item">
                <a class="page-link">></a>
            </li>
            <li class="page-item">
                <a class="page-link" href="../Watch.php">Men</a>
            </li>
            <li class="page-item">
                <a class="page-link">></a>
            </li>
            <li class="page-item active" aria-current="page">
                <a class="page-link" href="#">Titan Karishma Analog Black Dial Men's Watch <span class="visually-hidden">(current)</span></a>
            </li>
        </ul>
    </nav>
    ...
    <section class="product-container container mt-3">
        <!-- left side -->
        <div class="img-card">
            <img src="../images/product_details_image/titanmenwatch/1.jpg" alt="" id="featured-image">
            <!-- small img -->
            <div class="small-Card">
                <img src="../images/product_details_image/titanmenwatch/1.jpg" alt="" class="small-Img">
                <img src="../images/product_details_image/titanmenwatch/2.jpg" alt="" class="small-Img">
                <img src="../images/product_details_image/titanmenwatch/3.jpg" alt="" class="small-Img">
                <img src="../images/product_details_image/titanmenwatch/4.jpg" alt="" class="small-Img">
            </div>
        </div>
        <!-- Right side -->
        <div class="product-info" style="width: 800px;">
            <h1 class="bold">Titan Karishma Analog Black Dial Men's Watch</h1>
            <p class="disc">5K+ bought in past month | 6,393 ratings</p>
            <hr>
            <p class="h4"><span class="text-danger">-25%</span> ₹ 2,091</p>
            <p class="text-muted">M.R.P.: <strike> 2,775</strike></p>
            ...
            <div class="d-flex gap-3">
                <form method="post" action="" class="w-100">
                    ...
                    <input type="hidden" name="product_name" value="Titan Karishma Analog Black Dial Men Watch">
    ...
    <hr>
    <div class="container">
        <p style="text-align: center;font-weight:600; font-size:20px;">Titan Karishma Analog Black Dial Men's Watch</p>
        <div class="d-flex">
            <div class="w-100 d-flex flex-column">
                <table>
                    <tbody>
                        <tr>
                            <td class="bg-light p-2">Band Colour </td>
                            <td class="p-2">Silver</td>
                        </tr>
                        <tr>
                            <td class="bg-light p-2">Band Material </td>
                            <td class="p-2">Stainless Steel</td>
                        </tr>
                        <tr>
                            <td class="bg-light p-2">Band Width </td>
                            <td class="p-2">20 Millimeters</td>
                        </tr>
                        <tr>
                            <td class="bg-light p-2">Bezel Function </td>
                            <td class="p-2">No bezel available</td>
                        </tr>
                        <tr>
                            <td class="bg-light p-2">Brand </td>
                            <td class="p-2">Titan</td>
                        </tr>
                    </tbody>
                </table>
            </div>
            <div class="w-100 d-flex flex-column">
                <table>
                    <tbody>
                        <tr>
                            <td class="bg-light p-2">Case Diameter </td>
                            <td class="p-2">44 Millimeters</td>
                        </tr>
                        <tr>
                            <td class="bg-light p-2">Case Material </td>
                            <td class="p-2">Brass</td>
                        </tr>
                        <tr>
                            <td class="bg-light p-2">Case Thickness </td>
                            <td class="p-2">15 Millimeters</td>
                        </tr>
                        <tr>
                            <td class="bg-light p-2">Clasp</td>
                            <td class="p-2">Sliding Clasp</td>
                        </tr>
                        <tr>
                            <td class="bg-light p-2">Collection</td>
                            <td class="p-2">Karishma</td>
                        </tr>
                    </tbody>
                </table>
            </div>
            <div class="w-100 d-flex flex-column">
                <table>
                    <tbody>
                        <tr>
                            <td class="bg-light p-2">Dial Colour </td>
                            <td class="p-2">Black</td>
                        </tr>
                        <tr>
                            <td class="bg-light p-2">Crystal Material </td>
                            <td class="p-2">Mineral</td>
                        </tr>
                        <tr>
                            <td class="bg-light p-2">Display Type </td>
                            <td class="p-2">Analog</td>
                        </tr>
                        <tr>
                            <td class="bg-light p-2">Case Shape </td>
                            <td class="p-2">Round</td>
                        </tr>
                        <tr>
                            <td class="bg-light p-2">Special Features </td>
                            <td class="p-2">Water Resistant</td>
                        </tr>
                    </tbody>
                </table>
            </div>
