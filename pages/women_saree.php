...
<head>
    ...
    <title>Kanjivaram Soft Pure Silk Saree</title>
...
<body>
    ...
    <nav aria-label="..." style="width:83%; margin:10px auto; ">
        <ul class="pagination">
            ...
            <li class="page-item">
                <a class="page-link" href="../Fashion.php">Women</a>
            </li>
            <li class="page-item">
                <a class="page-link">></a>
            </li>
            <li class="page-item active" aria-current="page">
                <a class="page-link" href="#">Kanjivaram Soft Pure Silk Saree <span class="visually-hidden">(current)</span></a>
            </li>
        </ul>
    </nav>
    ...
    <section class="product-container container mt-3">
        <!-- left side -->
        <div class="img-card">
            <img src="../images/product_details_image/womensaree/1.jpg" alt="" id="featured-image">
            <!-- small img -->
            <div class="small-Card">
                <img src="../images/product_details_image/womensaree/1.jpg" alt="" class="small-Img">
                <img src="../images/product_details_image/womensaree/2.jpg" alt="" class="small-Img">
                <img src="../images/product_details_image/womensaree/3.jpg" alt="" class="small-Img">
                <img src="../images/product_details_image/womensaree/4.jpg" alt="" class="small-Img">
            </div>
        </div>
        <!-- Right side -->
        <div class="product-info" style="width: 800px;">
            <h1 class="bold">Avantika Fashion Women's Kanjivaram Soft Pure Silk Saree With Blouse Piece</h1>
            <p class="disc">5K+ bought in past month | 6,393 ratings</p>
            <hr>
            <p class="h4"><span class="text-danger">-86%</span> ₹ 499</p>
            <p class="text-muted">M.R.P.: <strike> 3,499</strike></p>
            ...
            <div class="d-flex gap-3">
                <form method="post" action="" class="w-100">
                    ...
                    <input type="hidden" name="product_name" value=" Kanjivaram Soft Pure Silk Saree">
    ...
    <hr>
    <div class="container">
        <p style="text-align: center;font-weight:600; font-size:20px;">Kanjivaram Soft Pure Silk Saree</p>
        <div class="d-flex">
                ...
                <table>
                    <tbody>
                        <tr>
                            ...
                            <td class="p-2">30 x 28 x 2 cm; 560 Grams</td>
                        </tr>
                        <tr>
                            <td class="bg-light p-2">Manufacturer </td>
                            <td class="p-2">Avantika Fashion</td>
                        </tr>
                        <tr>
                            <td class="bg-light p-2">Item model number </td>
                            <td class="p-2">Kovai Pattu kanchipuram silk saree</td>
                        </tr>
                        <tr>
            ...
            <div class="w-100 d-flex flex-column">
                <table>
                    <tbody>
                        <tr>
                            <td class="bg-light p-2">Packer </td>
                            <td class="p-2">AVANTIKA FASHION</td>
                        </tr>
                        <tr>
                            <td class="bg-light p-2">Item Weight</td>
                            <td class="p-2">560 g</td>
                        </tr>
                        <tr>
                            <td class="bg-light p-2">Item Dimensions LxWxH </td>
                            <td class="p-2"> 30 x 28 x 2 Centimeters</td>
                        </tr>
                        <tr>
                            <td class="bg-light p-2">Net Quantity </td>
                            <td class="p-2">1.00 count</td>
                        </tr>
                        <tr>
                            <td class="bg-light p-2">Included Components</td>
                            <td class="p-2">with blouse piece</td>
                        </tr>
                    </tbody>
                </table>
            </div>
            <div class="w-100 d-flex flex-column">
                <table>
                    <tbody>
                        <tr>
                            <td class="bg-light p-2">Generic Name </td>
                            <td class="p-2">saree</td>
                        </tr>
                        <tr>
                            <td class="bg-light p-2">Weave Type</td>
                            <td class="p-2">Banarasi</td>
                        </tr>
                        <tr>
                            <td class="bg-light p-2">Material Composition </td>
                            <td class="p-2">Pure Silk</td>
                        </tr>
                        <tr>
                            <td class="bg-light p-2">Design Name</td>
                            <td class="p-2">Zari</td>
                        </tr>
                        <tr>
                            <td class="bg-light p-2">Length</td>
                            <td class="p-2">6 yards</td>
                        </tr>
                    </tbody>
                </table>
            </div>
