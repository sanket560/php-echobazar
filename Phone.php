...
<body>
    ...
    <div id="carouselBasicExample" class="carousel slide carousel-fade" data-mdb-ride="carousel" data-mdb-carousel-init>
        ...
        <div class="carousel-inner">
            <div class="carousel-item active">
                <img src="images/banner/5.jpg" class="d-block w-100" style="height: 640px;" alt="Sunset Over the City" />
            </div>

            <div class="carousel-item">
                <img src="images/banner/6.jpg" class="d-block w-100" style="height: 640px;" alt="Canyon at Nigh" />
            </div>

            <div class="carousel-item">
                <img src="images/banner/7.jpg" class="d-block w-100" style="height: 640px;" alt="Cliff Above a Stormy Sea" />
            </div>
        </div>
    ...
    <!-- main -->
    <div class="container">
        <h1 class="text-center m-3 text-black">BUDGET SMARTPHONE</h1>
        <div class="products">
            <div class="row justify-content-center">
                <?php
                $select_product = mysqli_query($conn, "SELECT * FROM `products` WHERE category = 'phone'") or die('query failed');
                ...
                ?>
                <img src="images/banner/8.jpg" class="w-100" alt="">
            </div>
        </div>
    </div>
    <!-- Footer -->
